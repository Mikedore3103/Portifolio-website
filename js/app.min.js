...
const content = document.querySelector("body"),
  ...
  loadingItems = loadingWrap ? loadingWrap.querySelectorAll(".loading__item") : [],
  fadeInItems = document.querySelectorAll(".loading__fade"),
  loader = document.getElementById("loader"),
  imgLoad = typeof imagesLoaded === "function" && content ? imagesLoaded(content) : null;
let loaderFinished = !1;
...
startLoader(), imgLoad && "function" == typeof imgLoad.on && imgLoad.on("done", finishPageLoad), $(window).on("load", finishPageLoad), setTimeout(finishPageLoad, 6e3);
